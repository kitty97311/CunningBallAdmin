                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex px-2 py-1">
                                                    <div class="d-flex flex-column justify-content-center">
                                                        <p class="mb-0 text-sm">{{ ($admins->currentPage() - 1) * $admins->perPage() + $loop->iteration }}</p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                            ...
                                            <td class="align-middle text-center">
                                                <span class="text-secondary text-xs font-weight-bold">{{ ucfirst($admin->role) }}</span>
                                            </td>
                                            <td class="align-middle text-center">
                                                <span class="text-secondary text-xs font-weight-bold">{{ ucfirst($admin->state) }}</span>
                                            </td>
                                            <td class="align-middle text-center">
